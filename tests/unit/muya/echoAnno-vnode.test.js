...
const echoAnnoMod = require('../../../src/muya/lib/parser/render/renderInlines/echoAnno.js')
const echoAnno = echoAnnoMod.default || echoAnnoMod

const CLASS_OR_ID = require('../../../src/muya/lib/config/index.js').CLASS_OR_ID

// 模拟 render context —— echoAnno 用 this.getClassName(outerClass, block, token, cursor)
// 真实 production 走 src/muya/lib/parser/render/index.js 的 getClassName()：
